...
// constructionCmd represents the construction command
var constructionCmd = &cobra.Command{
	Use:   "con",
	Short: "Enables writes to a blockchain",
	Long: `
                 Caller                                + Construction API Implementation
                              +----------------------------------------------------------------------------------+
                                                                     |
...
func init() {
	constructionCmd.PersistentFlags().StringVarP(&fromFile, "from-file", "i", "", "use json encoded file for input")
	...
	// constructionCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// constructionCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
